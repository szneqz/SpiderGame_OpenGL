...
public:
	...
	void addTextures(const string& diffuse, const string& specular);
	...
	void setCurrentAnimation(unsigned int nr);
...
private:
	...
	string directory;
	vector<Texture> tempTextures;	//zmienna tekstur - specjalnie dla typow nie obslugujacych materialsow
	...
	unsigned int currentAnimation = 0;	//aktualnie odgrywana animacja
